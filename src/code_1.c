...
INCLUDE_ASM("asm/matchings", sub_8013F3C);
...
void sub_801682C(void)
{
    ...
    var_r2 = gPartyMemberIds[(u8)(gUnk_03000188[0] - 1)];
    if (var_r2 != 0)
    {
        var_r2--;
    }
...
void sub_80168A8(void)
{
    ...
    var_r0 = gPartyMemberIds[gUnk_03000226];
...
u8 sub_8016978(void)
{
    ...
    for (i = 0; i <= 0xF; i++)
    {
        if (gInventory[gUnk_0839CFAA[i]] != 0)
        {
            return i + 1;
        }
    }
...
INCLUDE_ASM("asm/matchings", sub_80169EC);
...
INCLUDE_ASM("asm/matchings", sub_801761C);
...
void sub_801A0F0(void) {
    if(gUnk_03000348[0].field_C || gUnk_03000348[1].field_C != 0 || gUnk_03000348[2].field_C != 0)
    {
...
void sub_801B760(u16 arg0)
{
    ...
    gUnk_03000518[arg0/8] |= (1 << (arg0 % 8));
}

u8 sub_801B790(u16 arg0)
{
    if ((gUnk_03000518[arg0 / 8] >> (arg0 % 8 )) & 1) return 1;
    return 0;
}
...
INCLUDE_ASM("asm/matchings", sub_80209EC);
INCLUDE_ASM("asm/nonmatchings", sub_8020A0C);
INCLUDE_ASM("asm/matchings", sub_8020A7C);
/*
...
INCLUDE_ASM("asm/matchings", sub_8020B04);
u32 sub_8020B48(void)
{
    return gUnk_03000718;
}
INCLUDE_ASM("asm/nonmatchings", sub_8020B54);
INCLUDE_ASM("asm/matchings", sub_8020B90);
INCLUDE_ASM("asm/matchings", sub_8020BC0);
/*
...
*/
INCLUDE_ASM("asm/matchings", sub_8020BF0);
...
INCLUDE_ASM("asm/matchings", sub_8048A68);
...
INCLUDE_ASM("asm/matchings", sub_804F250);
...
INCLUDE_ASM("asm/matchings", sub_8052758);
...
INCLUDE_ASM("asm/matchings", sub_8052858);
...
u32 sub_8052F20(u32 *ptr)
{
    u8 *data;

    data = (u8 *)*ptr;
    if (sub_8004FD0(data[1]) != 0)
    {
        *ptr += 2;
        return 1;
...
INCLUDE_ASM("asm/matchings", sub_80530D4);
/*
u32 sub_80530D4(u32 *ptr)
{
    u8 *data;
...
//     if(gSilverAmount > (ptr[2] + (ptr[3] << 8)))
//     {
//         idx = ptr[1];
