...
ifeq (modern,$(MAKECMDGOALS))
  $(error Modern compilers are not supported yet)
endif
...
ifeq ($(MODERN),0)
  ...
  override CFLAGS += -mthumb-interwork -Wimplicit -Wparentheses -Werror -O$(O_LEVEL) -fhex-asm -ffix-debug-line -fprologue-bugfix
...
$(C_BUILDDIR)/m4a_tables.o: CFLAGS := -mthumb-interwork -Wimplicit -Wparentheses -Werror -O2 -g -fhex-asm -ffix-debug-line
$(C_BUILDDIR)/m4a.o: CC1 := $(TOOLS_DIR)/agbcc/bin/old_agbcc
$(C_BUILDDIR)/m4a.o: CFLAGS := -mthumb-interwork -Wimplicit -Wparentheses -Werror -O2 -g -fhex-asm -ffix-debug-line
