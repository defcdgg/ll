...
**Save_SyncShadow (0x08016A14, code_8010F10) ✅ 2026-09-02**: 把 0x02027000 影子缓冲数据按
gUnk_080981E6 长度表逐块拷回 gUnk_087EB1E8 指向的真实块 (Save_LoadContinue 的逆操作),
源偏移从 0xC 起连续递增。与 0x02027000 镜像区 / 长度表配套, 见 progress.md 2026-09-02。
